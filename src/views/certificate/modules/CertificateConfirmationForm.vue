        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="溯源结果" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="traceabilityResultsRemark">
              <a-input v-model="model.traceabilityResultsRemark" placeholder="请输入溯源结果"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="溯源结果图片" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="traceabilityResults">
              <j-image-upload isMultiple  v-model="model.traceabilityResults" ></j-image-upload>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
