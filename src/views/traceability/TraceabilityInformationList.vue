<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('溯源信息')">导出</a-button>
    ...
    <traceability-information-modal ref="modalForm" @ok="modalFormOk"></traceability-information-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/traceability/traceabilityInformation/list",
