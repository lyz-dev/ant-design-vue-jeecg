    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="证书单位名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="certificateUnitName">
              <a-input v-model="model.certificateUnitName" placeholder="请输入证书单位名称"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/corporation/add",
          edit: "/corporation/edit",
          queryById: "/corporation/queryById"
        }
      }
    },
    computed: {
